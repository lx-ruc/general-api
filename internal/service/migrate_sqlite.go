...
var migrateTables = []string{
	...
	"user_model_grants", "cost_centers", "api_keys", "access_tokens", "usage_logs",
	"quota_grants", "quota_requests", "recharge_requests", "audit_logs",
	"period_balances", "vendor_bills", "settings",
}
